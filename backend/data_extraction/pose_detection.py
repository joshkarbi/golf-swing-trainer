...
def run_inference_and_overlay_movenet_on_frame(image: Image) -> Tuple[Image, InferenceResult]:
    global crop_region
    image_height, image_width, _ = image.shape
    ...
    return im, keypoints_with_scores

def reset_crop_region():
    global crop_region
    crop_region = None